...
results_dir="$parent_dir/results/prediction-runs/prediction-run-$flow_size_distribution-$coflowiness-coflowiness"
mkdir -p $results_dir
...
for ((i = 1; i <= iterations; i++)); do
    ...
    sudo sh $bench_tools_dir/load_associate_flows.sh
